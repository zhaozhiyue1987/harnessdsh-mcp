 ...
 */
export declare function syncTools(client: Client, ctx: Context, opts: ToolBridgeOptions, previous: ToolDisposers, onSynced?: (tools: readonly McpToolDescriptor[]) => void): Promise<ToolDisposers>;
